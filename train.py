    ...
    def __init__(self, data_file_name, data_dir='.data/'):
        ...
        with open(data_path, encoding='utf-8') as csv_file:
            ...
            for row in csv_reader:
                if len(row) == 3:
                    number, category, quote = row
                    data_str = f"{quote}{self.end_of_text_token}"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_file',
                        default=r'C:/Users/MSI/Downloads/TextAugmentation-GPT2-master/TextAugmentation-GPT2-master/data/updated_inspiration .csv',
                        type=str, action='store', help='Path to the data file')
